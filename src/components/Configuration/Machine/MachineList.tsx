...
import "../../../styles/Configuration/Machine/Machinelist.css";
...
// =====================================================
// Styles — defined before the component to avoid
// "cannot find name" errors from hoisting
// =====================================================
...
const paginationArrow = (disabled: boolean): CSSProperties => ({
  width: "24px",
  height: "24px",
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.header}>
        <span style={styles.title}>List of Machine ({rows.length})</span>
      ...
      <div style={styles.card}>
          ...
          <table style={styles.table}>
            <thead style={styles.thead}>
              <tr>
                ...
                <th style={{ ...th, textAlign: "center" }}>No. of Parameters linked</th>
                ...
                paginatedRows.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td style={{ ...td, textAlign: "center" }}>
                      <button
                        type="button"
                        aria-label={row.isActive ? "Deactivate machine" : "Activate machine"}
        ...
        <div style={styles.pagination}>
          ...
          <div style={styles.pageButtons}>
            <button
              type="button"
              style={paginationArrow(safePage === 1)}
              disabled={safePage === 1}
            ...
            <button
              type="button"
              style={paginationArrow(safePage === totalPages)}
